...
export function SessionCard({ session, index = 0, onDelete }: SessionCardProps) {
  ...
  const isProtected = session.worktreeId === 'main' || session.worktreeId === 'develop' || session.worktreeId === 'master' || !session.worktreeId;
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
            ...
            {/* Delete Button */}
            {onDelete && !isProtected && isHovered && (
